<form action="{{ route("admin.user.store") }}" method="POST">
    ...
    <input name="first_name" id="first_name" value="{{ old("first_name") }}" required autofocus>
    ...
    <input name="last_name" id="last_name" value="{{ old("last_name") }}" required autofocus>
    ...
    <input name="username" id="username" value="{{ old("username") }}" required autofocus>
